...
the compact artifact + manifest (CONTRACT 2) and a flat index.json.
    ...
    python -m pmlab.pipeline            # all cases
    python -m pmlab.pipeline EX02_epidemic --seed 7
"""
...
# data-pipeline/pmlab/pipeline.py -> parents[2] = repo root (works under `pip install -e .` too)
