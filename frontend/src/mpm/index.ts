...
export { analyzeCase, analyzeCube } from './analyze.ts';
...
export { REAL_CASES, realCaseById, cubeFromFile } from './real.ts';
export type { RealCase, RealCubeFile, RealLayerMeta } from './real.ts';
