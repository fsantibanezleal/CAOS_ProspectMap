...
export default function Introduction() {
  ...
  return (
    <article className="page-body prose">
      ...
      <ul>
        <li>{es ? 'Es generación de blancos de exploración (decision support de dónde mirar a continuación).' : 'It is exploration target generation (decision support for where to look next).'}</li>
        <li>{es ? 'No es una estimación de recursos/reservas (la frontera JORC / NI 43-101), ni una garantía de "perforar aquí".' : 'It is not a resource/reserve estimate (the JORC / NI 43-101 boundary), nor a "drill here" guarantee.'}</li>
